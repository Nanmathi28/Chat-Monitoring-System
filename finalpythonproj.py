...
class ChatMonitor:
    def __init__(self):
        ...
        self.chat_log = scrolledtext.ScrolledText(main_frame, wrap=tk.WORD, width=70, height=18, bg="#ffffff", fg="#333333", font=("Arial", 12))
        ...
        self.message_entry = tk.Entry(input_frame, width=40, bg="#ffffff", fg="#333333", font=("Arial", 12), insertbackground="black")
        self.message_entry.pack(side=tk.LEFT, padx=5, fill=tk.X, expand=True)
        self.message_entry.bind('<Return>', self.send_message)
        
        send_btn = tk.Button(input_frame, text="Send", command=self.send_message, bg="#4CAF50", fg="white", font=("Arial", 10, "bold"), 
        ...
        clear_btn = tk.Button(control_frame, text="Clear Chat", command=self.clear_chat, bg="#f44336", fg="white", font=("Arial", 10, "bold"), 
                            activebackground="#da190b", padx=10, pady=2)
        clear_btn.pack(side=tk.LEFT, padx=5)
        
        report_btn = tk.Button(control_frame, text="View Reports", command=self.view_reports,  bg="#2196F3", fg="white", font=("Arial", 10, "bold"), 
                             activebackground="#1976D2", padx=10, pady=2)
        report_btn.pack(side=tk.LEFT, padx=5)
        
        self.status = tk.Label(main_frame, text="Monitoring active...", bg="#e0e0e0", fg="#333333", font=("Arial", 10), anchor="w", pady=2)
        ...
        self.admin_log = scrolledtext.ScrolledText(self.admin_window, wrap=tk.WORD, width=60, height=15, bg="#ffffff", fg="#333333", font=("Arial", 12))
    ...
    def view_reports(self):
        try:
            ...
            if logs:
                ...
                report_text = scrolledtext.ScrolledText(report_window, wrap=tk.WORD, width=50, height=15, bg="#ffffff", fg="#333333", font=("Arial", 12))
